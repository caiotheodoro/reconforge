...
|---|---|---|---|---|---|---|---|---|
| Base Qwen3-1.7B-4bit (zero-shot) | — | 0.6002 | 0.852 [0.809, 0.893] | 0.717 [0.677, 0.755] | 0.145 [0.089, 0.206] | — | 0.9988 | ablation: what the fine-tune bought |
| Fine-tuned Qwen3-1.7B (iter 700, abort) | 0.7812 | 0.7291 | — | — | — | — | 1.0000 | self-consistency ×3 |
| DeepSeek `deepseek-v4-flash` | **0.8762** | 0.8719 | **1.000** [1.000, 1.000] | **0.904** [0.880, 0.926] | **0.006** [0.001, 0.013] | — | 0.9962 | frontier baseline, zero-shot; 0 false positives |
| **Fine-tuned Qwen3-1.7B (iter 740)** | 0.8050 | **0.9128** | 0.813 [0.773, 0.850] | 0.827 [0.798, 0.855] | **0.000** [0.000, 0.000] | **1.0000** | **1.0000** | self-consistency ×3, loss plateau 0.088; 74 false positives |
| Fine-tuned Qwen3-1.7B (champion ×5) | 0.8050 | 0.9007 | 0.824 [0.785, 0.862] | 0.824 [0.794, 0.852] | 0.000 [0.000, 0.000] | 1.0000 | 1.0000 | self-consistency ×5; 67 false positives |
...
DeepSeek's is 0.006 (5 escalations), and the degenerate escalate-everything
...
| Flag precision [95% CI] | 0.727 [0.636, 0.818] | 0.852 [0.809, 0.893] |
